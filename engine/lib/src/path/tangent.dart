...
void tangentLine(
    Float32List pts, double x, double y, List<Offset> tangents) {
...
Offset _evalQuadTangentAt(double x0, double y0, double x1, double y1,
...
Offset _evalCubicTangentAt(Float32List points, int bufferPos, double t) {
  assert(t >= 0 && t <= 1.0);
...
Offset _evalCubicDerivative(double x0, double y0, double x1, double y1,
  ...
  return Offset(coeff.evalX(t), coeff.evalY(t));
}
