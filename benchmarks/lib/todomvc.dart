...
class TodoAppState extends State<TodoApp> with SingleTickerProviderStateMixin {
  ...
  int? get editingTodoId => _editingTodoId;
  ...
  void addTodo() {
    ...
    setState(() {
      final newTodo = Todo(id: nextTodoId(), text: _textController.text.trim());
      _todos.add(newTodo);
  ...
  Widget _buildFilterButton(
    ...
    return TextButton(
      ...
      style: TextButton.styleFrom(
        foregroundColor: appState.filter == filterType
            ? Colors.red
            : Colors.grey,
      ),
      child: Text(text),
...
const int numberOfTodos = 20;

int nextTodoId() => _idCounter++;
